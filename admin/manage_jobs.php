...
if (isset($_POST['submit'])) {
    ...
    if(!empty($_POST['name']) && !empty($_POST['nameAr']) && !empty($_POST['desc']) && !empty($_POST['desc_Ar']) && !empty($_POST['qual']) && !empty($_POST['qual_Ar'])){
    $name = $_POST['name'];
    $nameAr = $_POST['nameAr'];
    ...
    //query
    $query = "INSERT into jobs (job_name,job_nameAr,job_desc,job_desc_Ar,job_qual,job_qual_Ar) values('$name','nameAr','$description','$desc_Ar','$qualification','$qual_Ar')";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-number" name="nameAr" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                           data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                           autocomplete="cc-number">
                                    <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="desc_Ar" type="text" id="textarea-input" rows="15" placeholder="Description..." class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="qual_Ar" type="text" id="textarea-input" rows="15" placeholder="Qualification..." class="form-control"></textarea>
                                    </div>
                                </div> 
                                <!--div class="form-group">
                    ...
                    <table class="table table-borderless table-data3 table-responsive" style="height: 500px;">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Full Name</th>
                        ...
                        <tbody>
                            ...
                            while ($adminset = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td> {$adminset['job_nameAr']}</td>";
                                echo "<td> {$adminset['job_desc']}</td>";
                                echo "<td> {$adminset['job_desc_Ar']}</td>";
                                echo "<td> {$adminset['job_qual']}</td>";
                                echo "<td> {$adminset['job_qual_Ar']}</td>";
                                echo "<td> <a href='edit_jobs.php?job_id={$adminset['job_id']}'class='btn btn-warning'>Edit</td>";
                                echo "<td> <a href='delete_jobs.php?job_id={$adminset['job_id']}'class='btn btn-danger'>Delete</td>";
                                echo "</tr>";
                            }
                            ?>

...
if (isset($_POST['submit'])) {
    ...
    //query
    $query = "INSERT into partners (par_name,par_nameAr,par_logo) values('$name','$nameAr','$file_name')";
//    echo $query;die;
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <label class="alert-danger">*Dimension will be 600*400</label>
                                </div>
                    ...
                    <table class="table table-borderless table-data3 text-center">
                        ...
                        <tbody>
                            ...
                            while ($adminset = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td> {$adminset['par_nameAr']}</td>";
                                echo "<td> <img src='partners_img/{$adminset['par_logo']}' width='150' height='150'></td>";
                                echo "<td> <a href='edit_partners.php?par_id={$adminset['par_id']}' class='btn btn-warning'>Edit</td>";
                                echo "<td> <a href='delete_partners.php?par_id={$adminset['par_id']}' class='btn btn-danger'>Delete</td>";
                                echo "</tr>";
                            }
                            ?>

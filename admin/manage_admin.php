                    ...
                    <table class="table table-borderless table-data3">
                        ...
                        <tbody>
                            ...
                            while ($adminset = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td> <a href='edit_admin.php?admin_id={$adminset['admin_id']}' class='btn btn-warning'>Edit</td>";
                                echo "<td> <a href='delete_admin.php?admin_id={$adminset['admin_id']}'class='btn btn-danger'>Delete</td>";
                                echo "</tr>";
                            }
                            ?>
